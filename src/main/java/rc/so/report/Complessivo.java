...
import static rc.so.exe.Utils.createDir;
...
public class Complessivo {
    ...
    private static final String loghisicilia = "/mnt/mcn/yisu_sicilia/loghisicilia_DEF.png";
                                    ...
                                    while (rs1.next()) {
                                        ...
                                        try (Statement st2 = db1.getConnection().createStatement(TYPE_SCROLL_INSENSITIVE, CONCUR_READ_ONLY); ResultSet rs2 = st2.executeQuery(sql2)) {
                                            ...
                                            Registro_completo docente = new Registro_completo(0,
                                                    ...
                                                    0,
                                                    "DOCENTE",
                                                    rs1.getString("d.cognome").toUpperCase(),
                                                    rs1.getString("d.nome").toUpperCase(),
                                                    rs1.getString("d.email").toLowerCase(),
                                                    rs1.getString("p.orainizio"),
                                                    rs1.getString("p.orafine"),
                                                    durata,
                                                    durata,
                                            ...
                                            while (rs2.next()) {
                                                Registro_completo rc = new Registro_completo(0,
                                                        ...
                                                        0,
                                                        "ALLIEVO",
                                                        rs2.getString("l.cognome").toUpperCase(),
                                                        rs2.getString("l.nome").toUpperCase(),
                                                        rs2.getString("l.email").toLowerCase(),
                            ...
                            if (!registro.isEmpty()) {
                                ...
                                if (moduli.size() > 1) {
                                    ...
                                    for (String ud1 : moduli) {
                                        ...
                                        cell0A.add(new Image(ImageDataFactory.create(loghisicilia)).setAutoScale(true));
                                        ...
                                        cell0B.add(new Paragraph("YES I START UP").addStyle(bold));
                                        cell0B.add(new Paragraph("Formarsi per diventare imprenditore/imprenditrice in Sicilia (YISU-SICILIA)").addStyle(bold));
                                        cell0B.add(new Paragraph("CUP G79B23000010009").addStyle(bold));
